...
Since Ratta promised to allow sideloading anyways as well as seeing the device coming wide open with a preinstalled su binary, test keys, open boot loader, (disabled) adb interface and other open doors I assume this will not create any unexpected inconvenience.
